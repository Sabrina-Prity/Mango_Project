...
class Payment_View(APIView):
    ...
    def post(self, request):
        ...
        post_body = {
            ...
            "success_url": f"https://sweet-haven-nu.vercel.app/payment/successs/?user_id={request.user.id}",
            # "success_url": f"http://127.0.0.1:8000/successs/",
            "fail_url": f"https://sweet-haven-nu.vercel.app/payment/fail/",        
            "cancel_url": f"https://sweet-haven-nu.vercel.app/payment/cancel/",    
            "emi_option": 0,
