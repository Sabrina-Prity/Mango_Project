...
class UserRegistrationApiView(APIView):
    ...
    def post(self, request):  
        ...
        if serializer.is_valid():
            ...
            print("uid ", uid)
            confirm_link = f"https://mango-project-six.vercel.app/customer/active/{uid}/{token}"
...
def activate(request, uid64, token):
    ...
    if user is not None and default_token_generator.check_token(user, token):
        user.is_active = True
        user.save()
        return redirect('https://sabrina-prity.github.io/Mango_Project_Frontend/login.html')
    else:
        return redirect('https://sabrina-prity.github.io/Mango_Project_Frontend/registration.html')
